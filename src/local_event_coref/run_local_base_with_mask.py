...
from src.local_event_coref.data import KBPCorefPair, get_dataLoader, SUBTYPES
from src.local_event_coref.modeling import BertForPairwiseECWithMask, RobertaForPairwiseECWithMask
...
def train(args, train_dataset, dev_dataset, model, tokenizer):
    """ Train the model """
    train_dataloader = get_dataLoader(args, train_dataset, tokenizer, shuffle=True, collote_fn_type='with_mask')
    dev_dataloader = get_dataLoader(args, dev_dataset, tokenizer, shuffle=False, collote_fn_type='with_mask')
...
def test(args, test_dataset, model, tokenizer, save_weights:list):
    test_dataloader = get_dataLoader(args, test_dataset, tokenizer, batch_size=1, shuffle=False, collote_fn_type='with_mask')
