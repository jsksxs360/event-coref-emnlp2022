...
def parse_args():
    ...
    parser.add_argument("--model_type",
        default="longformer", type=str, required=False
    )
    parser.add_argument("--model_checkpoint",
        default="allenai/longformer-base-4096", type=str, required=False,
        help="Path to pretrained model or model identifier from huggingface.co/models",
    )
    parser.add_argument("--max_seq_length", default=4096, type=int, required=False)
    ...
    parser.add_argument("--do_analysis", action="store_true", help="Whether to do analysis on the test set.")
